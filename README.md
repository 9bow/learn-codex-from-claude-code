...
Claude Code에 익숙한 사용자가 OpenAI Codex CLI, IDE 확장, ChatGPT 데스크톱 앱, Agent Skills, MCP, Codex Cloud 워크플로로 자연스럽게 이동할 수 있도록 정리한 한국어 학습 사이트입니다.

## 대상

- Claude Code의 slash commands, `CLAUDE.md`, hooks, subagents, skills, MCP를 이미 사용 중인 개발자
- Codex의 모델/추론 수준, approval/sandbox, AGENTS.md, ChatGPT 데스크톱 앱, 예약 작업을 비교 학습하려는 사용자
...
3. 설치와 인증: CLI, IDE 확장, ChatGPT 데스크톱 앱, ChatGPT 인증과 API 키 차이
...
8. ChatGPT Desktop App: projects, worktree, 예약 작업, thread context
9. 고급 기능: profiles, resume/fork, Codex Cloud, orchestration, MCP server, WebMCP, GitHub Action
...
- 설치, 인증, 모델 가용성, approval/sandbox, ChatGPT 데스크톱 앱처럼 변경 가능성이 큰 내용은 확인 가능한 명령과 점검 절차를 함께 둡니다.
